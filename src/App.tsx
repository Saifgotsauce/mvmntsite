  ...
  return (
    ...
    >
      ...
      <main>
        ...
        {/* Section 4: AI Demo - White with gradient */}
        <AIDemoSection />
        
        {/* Section 5: How It Works - White background */}
        <HowItWorks />
        
        {/* Section 6: Revenue Calculator - White with gradient accent */}
        <RevenueCalculator />
        
        {/* Section 7: Pricing - Light gray background */}
        <PricingSection />
        ...
        {/* Section 10: Footer - Dark with CTA */}
        <Footer />
      </main>
