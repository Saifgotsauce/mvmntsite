...
export default function VoiceModal({ children }: VoiceModalProps) {
  ...
  useEffect(() => {
    // Only load script when modal is opened
    ...
    const initializeWidget = () => {
      try {
        ...
        if (container && !container.hasChildNodes()) {
          ...
          widget.setAttribute('agent-id', 'agent_4501kf5q61e9fh9vnmqjnn5jry8e');
    ...
    if (existingScript) {
      ...
      script.onerror = () => {
        ...
        setError('Failed to load AI agent. Please check your connection.');
      };
        ...
        <div className="bg-gradient-to-b from-gray-50 to-white">
          <div className="p-6 min-h-[500px] flex items-center justify-center">
            {!scriptLoaded && !error && (
              <div className="text-center">
                ...
                <p className="text-gray-500 font-medium">Loading AI Agent...</p>
            ...
            <div
              ...
              className={`w-full flex items-center justify-center ${!scriptLoaded || error ? 'hidden' : ''}`}
            />
          </div>
          ...
          <div className="bg-gray-50 px-6 py-4 border-t border-gray-100">
            ...
            <p className="text-sm text-gray-600 text-center">
              "My furnace isn't working" or "I need to schedule an AC tune-up"
            </p>
          </div>
        </div>
      </DialogContent>
