...
import { Menu, X, Mic, Phone } from 'lucide-react';
          ...
          <div className="pt-20 px-6">
            <div className="flex flex-col gap-4">
              ...
              <button
                ...
                className={`flex items-center gap-2 text-lg font-medium text-gray-800 hover:text-brand-red transition-all duration-300 py-3 border-b border-gray-100 ${
                  isMenuOpen
                    ? 'opacity-100 translate-x-0'
                    : 'opacity-0 translate-x-10'
                }`}
